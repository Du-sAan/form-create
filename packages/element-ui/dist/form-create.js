...
(function (global, factory) {
    ...
    var Checkbox = vue.defineComponent({
      ...
      setup(props, _) {
        ...
        const opt = vue.toRef(props, 'options');
    ...
    function render$6(_ctx, _cache, $props, $setup, $data, $options) {
      return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$6, _cache[0] || (_cache[0] = [vue.createElementVNode("path", {
        fill: "currentColor",
    ...
    function render$5(_ctx, _cache, $props, $setup, $data, $options) {
      return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$5, _cache[0] || (_cache[0] = [vue.createElementVNode("path", {
        fill: "currentColor",
    ...
    function render$4(_ctx, _cache, $props, $setup, $data, $options) {
      return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$4, _cache[0] || (_cache[0] = [vue.createElementVNode("path", {
        fill: "currentColor",
    ...
    function render$3(_ctx, _cache, $props, $setup, $data, $options) {
      return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1$3, _cache[0] || (_cache[0] = [vue.createElementVNode("path", {
        fill: "currentColor",
    ...
    var Upload = vue.defineComponent({
      ...
      render() {
        ...
        return vue.createVNode("div", {
          ...
          default: () => [((_this$$slots$default = (_this$$slots = this.$slots).default) === null || _this$$slots$default === void 0 ? void 0 : _this$$slots$default.call(_this$$slots)) || (['text', 'picture'].indexOf(this.listType) === -1 ? vue.createVNode(vue.resolveComponent("ElIcon"), null, {
            default: () => [vue.createVNode(script$1, null, null)]
          }) : vue.createVNode(vue.resolveComponent("ElButton"), {
            "type": "primary"
          }, {
            default: () => [vue.createTextVNode("\u70B9\u51FB\u4E0A\u4F20")]
          }))],
          ...getSlot(this.$slots, ['default'])
    ...
    function render(_ctx, _cache, $props, $setup, $data, $options) {
      return vue.openBlock(), vue.createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [vue.createElementVNode("path", {
        fill: "currentColor",
    ...
    function $FormCreate(FormCreate, components, directives) {
      return vue.defineComponent({
        ...
        setup(props) {
          ...
          vue.watch(() => [props.disabled, props.preview], () => {
            fapi.refresh();
          });
          ...
          if (this.options.appendValue !== false) {
            Object.keys(this.appendData).reduce((initial, field) => {
              if (fields.indexOf(field) === -1) {
                initial[field] = vue.toRef(this.appendData, field);
              }
              return initial;
            }, data);
          }
    ...
    function useContext(Handler) {
      extend(Handler.prototype, {
        ...
        watchCtx(ctx) {
          ...
          ctx.refRule['__$title'] = vue.computed(() => {
          ...
          ctx.refRule['__$info'] = vue.computed(() => {
          ...
          ctx.refRule['__$validate'] = vue.computed(() => {
          ...
          this.bus.$once('load-end', () => {
            ...
            Object.keys(computedRule).forEach(k => {
              ...
              ctx.watch.push(vue.watch(computedValue, n => {
                oldValue = n;
                setTimeout(() => {
                  callback(n);
                });
    ...
    function FormCreateFactory(config) {
      ...
      extend(FormCreate.prototype, {
        init() {
          if (this.isSub()) {
            this.unwatch.push(vue.watch(() => this.vm.setupState.parent.setupState.fc.options.value, () => {
              this.initOptions();
